<%@	Page Language="VB" MasterPageFile="~/Default.master" Title="GallowayTech | Admin"
	CodeFile="Photos.aspx.vb" Inherits="Admin_Photos_aspx" %>
	...
	<div class="page" id="admin-photos">
		...
		<div id="content">
			...
			<asp:FormView ID="FormView1" Runat="server" 
				...
				<InsertItemTemplate>
					<asp:RequiredFieldValidator	ID="RequiredFieldValidator1" Runat="server" ErrorMessage="You must choose a	caption." ControlToValidate="PhotoCaption" Display="Dynamic" Enabled="false" />
					<p>
						Photo<br />
